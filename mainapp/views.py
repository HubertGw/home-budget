...
from .forms import ExpenseCategoriesFORM, ExpensesFORM, TodoForm, NewTodoForm, IncomesFORM
...
def get_name(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect('/kwota')

    # if a GET (or any other method) we'll create a blank form
    else:
        form = ExpenseCategoriesFORM()

    return render(request, 'wydatki.html', {'form': form})
